...
enum class Difficulty(val displayName: String, val texture: String, val color: Formatting) {
    ...
    NORMAL("Normal", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmYyYzM2NzgwYjdlYmExM2Y5NzIyMmViNGNmZWIyNjk5ZTcwYzQxYjU2MjY1YzgwYzNkYzFiYmYzYjM0MjBjMyJ9fX0=", Formatting.BLUE),
